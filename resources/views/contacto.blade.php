    ...
    <div class="row">
        <div class="col-md-12">
            <div class="well well-sm">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/mail/store') }}">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" id="message" name="mensaje" placeholder="Mensaje" rows="12"></textarea>
                            </div>
                        </div>
